...
- Project creator can delete their own project
- Admin can add an existing user as a member
...
- Dashboard shows total tasks, status counts, per-user tasks, and overdue tasks
- Frontend and backend work correctly after deployment

## Demo Video Suggested Flow

1. Show the login page and sign in as admin.
2. Show the dashboard and project list.
3. Create a new project.
4. Add an existing member by email.
5. Create a task and assign it to the member.
6. Update the task status.
7. Show dashboard metrics.
8. Log in as a member.
9. Show that the member can view and update only assigned tasks.
10. Briefly explain the backend models, routes, and role-based access.
...
- MongoDB Atlas connected through environment variables
